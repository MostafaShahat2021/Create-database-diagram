...
CREATE INDEX idx_treatment_histories_medical_histoy__id ON treatment_histories (medical_histoy__id);
CREATE INDEX idx_invoices_medical_histoy__id ON invoices (medical_histoy__id);
